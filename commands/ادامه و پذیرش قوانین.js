...
[{text: "🔄بررسی دسترس بودن ربات", callback_data: "ادامه و پذیرش قوانین"}]
]}
});
}
...
User.setProperty("Accepting_Rules", message);
...
Api.editMessageText({
message_id: request.message.message_id,
text: "✅کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") قوانین با موفقیت پذیرفته شد.\n\n" + DateTime + "",
parse_mode: "Markdown",
reply_markup: {inline_keyboard: [
[{text: "👁مشاهده خدمات جعلی", callback_data: "خدمات جعلی" }],
...
[{text: "🔄بررسی عضویت بودن کانال", callback_data: "ادامه و پذیرش قوانین"}]
]}
});
}
}
