...
[{text: "🔄بررسی دسترس بودن ربات", callback_data: "Payment-Gateway-1"}]
]}
});
}
...
HTTP.post({
url: 'https://zarinp.al/arminsoft',
success: "Payment-Gateway-2"
});
}
...
[{text: "🔄بررسی عضویت بودن کانال", callback_data: "Payment-Gateway-1"}]
]}
});
}
}
