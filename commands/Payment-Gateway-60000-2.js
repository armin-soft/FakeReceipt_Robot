/*CMD
  command: Payment-Gateway-60000-2
  help: 
  need_reply: 
  auto_retry_time: 
  folder: 
...
command: "Payment-Gateway-60000-3",
user_id: user.id,
...
Api.editMessageText({
message_id: request.message.message_id,
text: "✅کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") لینک پرداخت اختصاصی شما تعداد ۶۰ عدد الماس ایجاد گردید.\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.",
parse_mode: "Markdown",
