...
text: "🔄 افزایش الماس در حال بار گذاری می باشد...",
show_alert: false
})
...
text: "🌹مدیریت گرامی [" + Add_Admin_FullName + "](tg://user?id=" + Add_Admin_UserID + ") به افزایش الماس خوش آمدید.\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.",
parse_mode: "Markdown",
...
Bot.runCommand("افزایش الماس دوم");
