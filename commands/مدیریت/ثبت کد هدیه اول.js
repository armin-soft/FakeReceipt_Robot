...
text: "🔄 ثبت کد هدیه در حال بار گذاری می باشد...",
show_alert: false
})
...
text: "🌹مدیریت گرامی [" + Add_Admin_FullName + "](tg://user?id=" + Add_Admin_UserID + ") به ثبت کد هدیه خوش آمدید.\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات مدیریت بر روی منوی مورد نظر کلیک کنید.",
parse_mode: "Markdown",
...
Bot.runCommand("ثبت کد هدیه دوم");
