...
[{text: "🔄بررسی دسترس بودن ربات", callback_data: "رسید بانکی"}]
]}
});
}
...
text: "🔄رسید بانکی در حال بار گذاری می باشد...",
show_alert: false
})

Api.editMessageText({
message_id: request.message.message_id,
text: "🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش رسید بانکی خوش آمدید.\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.",
parse_mode: "Markdown",
reply_markup: {inline_keyboard: [
[{text: "🏧کاغذی نوع اول", callback_data: "کاغذی اول اول"},{text: "🏧کاغذی نوع دوم", callback_data: "کاغذی دوم اول"},{text: "🏧کاغذی نوع سوم", callback_data: "کاغذی سوم اول"}],
[{text: "🏧کاغذی نوع چهارم", callback_data: "کاغذی چهارم اول"},{text: "🏧کاغذی نوع پنجم", callback_data: "کاغذی پنجم اول"}],
[{text: "🏧۷۲۴", callback_data: "۷۲۴ اول"}],
[{text: "🔙بازگشت به منوی قبل", callback_data: "خدمات جعلی" }],
...
[{text: "🔄بررسی عضویت بودن کانال", callback_data: "رسید بانکی"}]
]}
});
}
}
