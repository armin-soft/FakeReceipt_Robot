...
[{text: "🔄بررسی دسترس بودن ربات", callback_data: "انتقال الماس اول"}]
]}
});
}
...
text: "🔄انتقال الماس اول در حال بار گذاری می باشد...",
show_alert: false
})
...
Api.editMessageText({
message_id: request.message.message_id,
text: "🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش انتقال الماس خوش آمدید.\n\n" + DateTime + "\n\n*⚠️نکته:جهت انتقال الماس آیدی عددی کاربر مورد نظر را از بخش پروفایل کاربری مشاهده کنید.\n➖➖➖➖➖➖➖➖➖➖\n💎الماس کنونی:" + (Decimal(Diamond.value())) + " " + (Currency(Diamond.value())) + "*\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.",
parse_mode: "Markdown",
reply_markup: {inline_keyboard: [
...
Bot.runCommand("انتقال الماس دوم");
}
...
[{text: "🔄بررسی عضویت بودن کانال", callback_data: "انتقال الماس اول"}]
]}
});
}
}
