...
Diamond.remove(2);
Bot.editMessage("✔️کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") *رسید کاغذی نوع سوم با موفقیت ساخته شد.*\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n*⏳رسید تا لحظاتی دیگر ارسال می شود.*", Edit);

Api.sendPhoto({
photo: "https://armin-soft.ir/Tools/Telegram-BOT/Service/Fake-Receipt/Fake/Bank/Paper-3/?Amount=" + Amount + "&Origin_Card=" + Origin_Card + "&Destination_Card=" + Destination_Card + "&FullName=" + FullName + "",
...
[{text: "📑ساخت رسید مجدد کاغذی نوع سوم", callback_data: "کاغذی سوم اول"}],
...
text: "*✅مدیریت گرامی لحظاتی پیش کاربر* [" + FirstName + "](tg://user?id=" + UserID + ") *رسید فیک کاغذی نوع سوم ساختند.*\n➖➖➖➖➖➖➖➖➖➖\n" + DateTime + "",
parse_mode: "Markdown",
});
}
...
Diamond.add(2);
Api.sendMessage({
text: "*❌کاربر گرامی* [" + FirstName + "](tg://user?id=" + UserID + ") *رسید کاغذی سوم ساخته نشد و همچنین تعداد ۲ عدد الماس بدلیل عملیات ناموفق به حساب شما عودت گردید.\n\n⚠️علت:شماره کارت مبدا یا مقصد به درستی وارد نشده است.*\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n*💎الماس کنونی:" + (Decimal(Diamond.value())) + " " + (Currency(Diamond.value())) + "*",
parse_mode: "Markdown",
reply_markup: {inline_keyboard: [
[{text: "📑ساخت رسید مجدد کاغذی نوع سوم", callback_data: "کاغذی سوم اول"}],
[{text: "🔙بازگشت به منوی رسید بانکی", callback_data: "رسید بانکی"}],
