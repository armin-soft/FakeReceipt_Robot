...
Api.editMessageText({
message_id: request.message.message_id,
text: "🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش منوی خدمات ربات خوش آمدید.\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n👌جهت استفاده از امکانات ربات بر روی منوی مورد نظر کلیک کنید.",
parse_mode: "Markdown",
reply_markup: {inline_keyboard: [
[{text: "👤پروفایل کاربری", callback_data: "پروفایل کاربری"}],
[{text: "🧨خدمات جعلی", callback_data: "خدمات جعلی"}],
[{text: "📌تغییرات نسخه", callback_data: "تغییرات نسخه"}],
[{text: "👨‍💻پشتیبانی آنلاین", callback_data: "پشتیبانی آنلاین"}],
[{text: "🤖درباره ربات", callback_data: "درباره ربات"}],
]}
});
}
