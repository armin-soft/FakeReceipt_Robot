...
[{text: "🔄بررسی دسترس بودن ربات", callback_data: "کاغذی سوم اول"}]
]}
});
}
...
text: "🔄کاغذی نوع سوم در حال بار گذاری می باشد...",
show_alert: false
})
...
Api.editMessageText({
message_id: request.message.message_id,
text: "🌹کاربر گرامی [" + FirstName + "](tg://user?id=" + UserID + ") به بخش کاغذی نوع سوم خوش آمدید.\n\n" + DateTime + "\n➖➖➖➖➖➖➖➖➖➖\n🙇‍♂️لطفا به پرسش هایی که از شما پرسیده می شود به درستی پاسخ دهید.",
parse_mode: "Markdown",
reply_markup: {inline_keyboard: [
...
[{text: "🔄بررسی عضویت بودن کانال", callback_data: "کاغذی سوم اول"}]
]}
});
}
}
