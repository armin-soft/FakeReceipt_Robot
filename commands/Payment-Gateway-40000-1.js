/*CMD
  command: Payment-Gateway-40000-1
  help: 
  need_reply: 
  auto_retry_time: 
  folder: 
...
[{text: "🔄بررسی دسترس بودن ربات", callback_data: "Payment-Gateway-40000-1"}]
]}
});
}
...
success: 'Payment-Gateway-40000-1'
});
return
}
...
HTTP.post({
url: 'https://armin-soft.ir/Tools/Telegram-BOT/Payment/Fake-Receipt/Payment-Gateway-40000/Request/',
success: "Payment-Gateway-40000-2"
});
}
...
[{text: "🔄بررسی عضویت بودن کانال", callback_data: "Payment-Gateway-40000-1"}]
]}
});
}
}
